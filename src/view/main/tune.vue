<template>
  <f7-page>
    <f7-navbar title="Today"></f7-navbar>
    ...
    <div class="demo-expandable-cards">
      ...
      <f7-card expandable>
        <f7-card-content :padding="false">
          <div :style="{background: 'url(../../../../assets/img/beach.jpg) no-repeat center bottom', 'background-size': 'cover', height: '240px'}"></div>
          <f7-link card-close color="white" class="card-opened-fade-in" :style="{position: 'absolute', right: '15px', top: '15px'}" icon-f7="close_round_fill"></f7-link>
      ...
      <f7-card expandable>
        <f7-card-content :padding="false">
          <div :style="{background: 'url(../../../../assets/img/monkey.jpg) no-repeat center top', 'background-size': 'cover', height: '400px'}">
...
<script>
  import { f7Navbar,f7NavRight,f7BlockTitle, f7Page, f7Block, f7Card, f7CardHeader, f7CardContent, f7Link, f7Button } from 'framework7-vue';
